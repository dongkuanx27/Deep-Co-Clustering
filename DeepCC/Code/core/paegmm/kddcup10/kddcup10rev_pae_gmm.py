...
import core.data.kddcup10rev.kddcup10rev as kddcup
...
class KddcupPaeGmmRev:
    ...
    def get_data(input_file):
        data = kddcup.KddcupDataRev(input_file)
    ...
    def run(self, data, train_epochs):
        ...
        precision, recall, f1 = self.accuracy(predict_lh, num_test_points, test_y, 0.2)
        # print train_out
