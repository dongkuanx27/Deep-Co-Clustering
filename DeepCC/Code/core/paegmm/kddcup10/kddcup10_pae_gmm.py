...
class KddcupPaeGmm:
    ...
    def run(self, data, train_epochs):
        ...
        train_step_2 = tf.train.AdamOptimizer(1e-5).minimize(obj_oa)
        ...
        for k in range(len(pretrain_col_step)):
            ...
            for i in range(3000):  # epoch_tot_col
...
'MI_org':self.MI_org, 'MI_red':self.MI_red, 'Ur_max_idx':self.Ur_max_idx, 'Uc_max_idx':self.Uc_max_idx}
        ...
        sio.savemat('/home/dsi/dxu/Research_Server/Working/Deep_co_clustering/Code/sr-gpu01/DCC_with_KL_divergence_loss_pretrain_basedGMMoutput/Coil20/RR_result_MIloss.mat', \
...
'RR_MI_org':RR_MI_org, 'RR_MI_red':RR_MI_red, 'acc_AE_Kmeans':acc_AE_Kmeans, 'nmi_AE_Kmeans':nmi_AE_Kmeans, 'pred_label_list':pred_label_list, 'pred_label_col_list':pred_label_col_list})
        ...
        sio.savemat('/home/dsi/dxu/Research_Server/Working/Deep_co_clustering/Baseline/Predict_labels/'+'DeepCC'+'_'+'coil20'+'_'+'prdlabel.mat', {'prd_lab':prd_lab, 'prd_lab_col':prd_lab_col})
