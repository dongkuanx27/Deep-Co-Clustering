...
class ThyroidPaeGmm:
    ...
    def get_data(input_file):
        data = thyroid.ThyroidData(input_file)
    ...
    def output_code(train_out, num_test_points):
        fout = open('../result/thyroid_output_batch_1.csv', 'w')
    ...
    def run(self, data, train_epochs):
        ...
        precision, recall, f1 = self.accuracy(predict_lh, num_test_points, test_y, 0.025)
        # print train_out
